 ...
 * @author USER
 */
public class EmployeeDetails1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(0, 130, 153));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      /*  try{
         ...
         id=jTextField1.getText();
         try{
          PreparedStatement ps=cn.prepareStatement("select * from emp where  P=(?)");
           ps.setString(1, id);
